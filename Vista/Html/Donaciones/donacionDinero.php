...
<body>
    ...
    <table border="1">
        ...
        <?php while ($fila = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td><?php echo $fila['Tipo_Dinero']; ?></td>
    ...
    <center><a href="/Vista/Html/Donaciones/ReporteD.php" style="display: inline-block; padding: 13px 55px; border: 1px solid black; border-radius: 25px; color: black; text-decoration: none;"> Generar Reporte </a></center> <br>
